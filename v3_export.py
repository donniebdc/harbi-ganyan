        ...
        daily_panel["surdirekler"] = [
            {
                ...
                # Canonical zenginlestirme (Asama2): /surdirek Flutter SurdirekItem
                # semasi icin gercek kaynak degerleri (SurdirekResult).
                "norm_score":  round(_sd.norm_score, 2),
                "win_rate":    round(_sd.win_rate, 2),
                "bucket_ad":   _sd.bucket,
                "source":      _sd.source,
            }
