...
class _GununState extends ConsumerState<GununAnalizleri>
  ...
  Widget build(BuildContext context) {
    ...
    return gunlerAsync.when(
      ...
      // skipError: yenileme sırasında geçici ağ hatası olursa eldeki veri
      // gösterilmeye devam etsin — "Bağlantı hatası" yalnız hiç veri yokken çıkar.
  ...
  Widget _icerik(AuthState auth, GunOzet secGun) {
    ...
    return detay.when(
      ...
      // skipError: geçici yenileme hatasında eldeki veri ekranda kalsın.
      skipLoadingOnReload: true,
      skipError: true,
      loading: () => const Yukleniyor(),
      error: (e, _) {
