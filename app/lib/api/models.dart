...
class GunDetay {
  ...
  final String tahminAsamasi; // 'on_tahmin' | 'final'
  ...
  GunDetay.fromJson(Map<String, dynamic> j)
      : date = j['date'] as String,
        ...
        tahminAsamasi = j['tahmin_asamasi'] as String? ?? 'final',
        hipodromlar = (j['hipodromlar'] as List)
...
class AnalizPuan {
  ...
  final String at;
  final double ana;
  final List<int> ekuPartnerNos;
  AnalizPuan.fromJson(Map<String, dynamic> j)
      : atNo = j['at_no'] as int,
        at = j['at'] as String? ?? '',
        ana = (j['ana'] as num).toDouble(),
        ekuPartnerNos = (j['eku_partner_nos'] as List? ?? [])
            .map((e) => e is int ? e : (e as Map<String, dynamic>)['at_no'] as int)
            .toList();
}
...
class Kosu {
  ...
  final List<AnalizPuan> analizPuanlari;
  Kosu.fromJson(Map<String, dynamic> j)
      : kno = j['kno'] as int,
        ...
        analizPuanlari = (j['analiz_puanlari'] as List? ?? [])
            .map((e) => AnalizPuan.fromJson(e as Map<String, dynamic>))
            .toList();
}
...
class SecilenAt {
  final int atNo;
  final String at;
  final List<Map<String, dynamic>> ekuPartnerNos;
